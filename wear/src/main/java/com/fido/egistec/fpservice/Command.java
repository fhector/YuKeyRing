...
public class Command {
    public static final byte[] REQUEST_ENROLL = {0x55, (byte) 0xaa, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, (byte) 0xae, (byte) 0x65};  // enrollment
    public static final byte[] REQUEST_VERIFY = {0x55, (byte) 0xaa, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, (byte) 0xb3, (byte) 0xa9};  // verification
    public static final byte[] REQUEST_DELETE = {0x55, (byte) 0xaa, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, (byte) 0xb8, (byte) 0xed};  // delete
    public static final byte[] REQUEST_CANCEL = {0x55, (byte) 0xaa, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, (byte) 0x88, (byte) 0x31};  // cancel
    public static final byte[] REQUEST_FORWARD = {0x55, (byte) 0xaa, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, (byte) 0x88, (byte) 0x31};  // foward
    public static final byte[] REQUEST_SET_DETECT_MODE = {0x55, (byte) 0xaa, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, (byte) 0x9e, (byte) 0xb9};  // 设置监测模式
    public static final byte[] REQUEST_CALIBRATION = {0x55, (byte) 0xaa, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, (byte) 0x95, (byte) 0xfd};  // 校准
    public static final byte[] REQUEST_GET_CONFIHURATION = {0x55, (byte) 0xaa, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, (byte) 0xf4, (byte) 0x45};  // 获取配置
    public static final byte[] REQUEST_SET_CONFIGURATION = {0x55, (byte) 0xaa, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, (byte) 0x00, (byte) 0x00};  // 设定配置
    public static final byte[] REQUEST_GET_COS_VERSION = {0x55, (byte) 0xaa, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, (byte) 0xda, (byte) 0x2e};  // cos version
